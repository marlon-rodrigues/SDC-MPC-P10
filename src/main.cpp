      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          /* 5 - Error calculation (CTE and Psi) and state definition */
          Eigen::VectorXd state(6);

          // Take latency under consideration
          const double latency = 0.1;
          cout << "px original " << px << endl;
          px = v * latency;
          cout << "px with latency " << px << endl;
          ...
          /* 6 - Solve (Computational Infrastructure for Operations Research Library) */
          cout << "Solving " << endl;
          ...
          /* 8 - Predict line visual for simulator */
